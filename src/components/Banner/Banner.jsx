    ...
    return (
        <div className="hero bg-[#9538E2]  min-h-[694px] max-w-[1540px] mx-auto flex flex-col rounded-2xl">
            <div className="hero-content text-center lg:max-w-[1120px]">
                <div className="py-12">
                    <h1 className=" text-2xl lg:text-5xl font-bold text-white leading-snug">Upgrade Your Tech Accessorize with Gadget Heaven Accessories</h1>
            ...
            <div className='p-6 bg-white/30 bg-opacity-15 border-2 rounded-3xl z-10 max-w-[1062px] mt-[360px] md:mt-[320px] absolute'>
                    <img src={bannerIMG}
